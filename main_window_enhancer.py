...
Each new options can be configured. Go to Tools>add-ons>[name of this
add-on]>Edit. Find the line called «USER CONFIGURATION». Below it, you
will see a few options. Each are explained.
...
class DeckNode:
    ...
    def __init__(self, mw, oldNode):
        ...
        self.unseenCards = result[6] or 0
